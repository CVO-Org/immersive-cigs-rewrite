...
private _defaultValue = switch (_side) do {
    case west:       { _className in ["cigs_morley_cigpack", "cigs_crayons_crayonpack" ] };
    case east:       { _className in ["cigs_Apollo_cigpack", "cigs_Kosmos_cigpack" ] };
    case resistance: { _className in ["cigs_baja_blast_cigpack", "cigs_black_devil_cigpack" ] };
...
[
    ...
    [LSTRING(set_mainCat_ai), format ["%1 - %2", LSTRING(set_subCat_cigsonai), _side]],			//    _category    - Category for the settings menu + optional sub-category <STRING, ARRAY>
