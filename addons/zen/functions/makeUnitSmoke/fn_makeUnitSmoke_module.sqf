...
if  ( _unit getVariable [QPVAR(isConsuming), false] isEqualTo "SMOKE" ) exitWith { [LLSTRING(module_makeUnitSmoke_alreadySmoking) ] call zen_common_fnc_showMessage; };
if  ( _unit getVariable [QPVAR(isConsuming), false] isEqualTo "SUCK"  ) exitWith { [LLSTRING(module_makeUnitSmoke_alreadySucking) ] call zen_common_fnc_showMessage; };
